...
public interface CalcPrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    default long avg(long[] nums)
        throws EmptySequenceException
    {
        return avg(nums, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default long avg(long[] nums, java.util.Map<String, String> context)
        throws EmptySequenceException
    {
        try
        {
            return _iceI_avgAsync(nums, context, true).waitForResponseOrUserEx();
        }
    ...
    default java.util.concurrent.CompletableFuture<java.lang.Long> avgAsync(long[] nums)
    {
        return _iceI_avgAsync(nums, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<java.lang.Long> avgAsync(long[] nums, java.util.Map<String, String> context)
    {
        return _iceI_avgAsync(nums, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<java.lang.Long> _iceI_avgAsync(long[] iceP_nums, java.util.Map<String, String> context, boolean sync)
    {
